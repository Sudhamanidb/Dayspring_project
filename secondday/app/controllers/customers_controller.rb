class CustomersController < ApplicationController
  ...
  def index
    ...
    # @customers = Customer.type_of{name :sudha}
  ...
  def create
    ...
    respond_to do |format|
      if @customer.save #after saving the data only we have send mails 
        CustomerMailer.with(customer:@customer).welcome_email.deliver #main line to trigger an email
  ...
  private
    ...
    def customer_params
      params.expect(customer: [ :name, :email, :dob, :phone_number, :about_me])
    end
